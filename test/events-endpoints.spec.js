...
const {
  makeEventsArray, makeUsersArrayForEventTest, makeAttendeesArrayForEventTest, seedUsers,
} = require('./events.fixtures');
...
describe('Events Endpoints', () => {
  ...
  describe('GET /api/events', () => {
    ...
    context('Given there are events in the database', () => {
      ...
      it('responds with 200 and all of the events', () => supertest(app)
        .get('/api/events')
